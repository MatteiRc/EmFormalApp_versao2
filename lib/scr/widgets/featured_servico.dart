...
import 'package:flutter_app/scr/telas/detalhes.dart';
          ...
          itemBuilder: (_, index){
            return Padding(padding: EdgeInsets.fromLTRB(12, 14, 16, 12),
                child: GestureDetector(
                  onTap: (){
                    changeScreen(_, Detalhes(servico: servicoList[index],));
                  },
                  child: Container(
                    height: 220,
                    width: 200,
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: Titulo(text: "\R\$${servicoList[index].preco}" + "\n/hora", weight: FontWeight.bold,),),
                              ],
                            ),
